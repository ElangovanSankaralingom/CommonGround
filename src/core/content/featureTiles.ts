...
export const HYBRID_TILES: HybridTile[] = [
  ...
  { id: 'night_cafe_hybrid', name: 'Evening Food Court', mergedFrom: ['night_market', 'cafe_space'], icon: 'local_cafe',
    ...
    resourceCost: { budget: 3, knowledge: 0, volunteer: 3, material: 3, influence: 3 },
    savingsVsOriginal: { budget: 1, knowledge: 1, volunteer: 1, material: 1, influence: 2 },
  ...
  { id: 'access_path_hybrid', name: 'Universal Access Pathway', mergedFrom: ['disability_access', 'walking_path'], icon: 'accessible',
    ...
    resourceCost: { budget: 3, knowledge: 1, volunteer: 2, material: 4, influence: 1 },
    savingsVsOriginal: { budget: 1, knowledge: 1, volunteer: 1, material: 1, influence: 1 },
