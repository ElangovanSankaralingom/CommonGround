...
export const FEATURE_TILES: VisionFeatureTile[] = [
  { id: 'drainage_system', name: 'Drainage System Repair', icon: 'plumbing',
    ...
    compatibleZones: ['z1', 'z3', 'z4', 'z5', 'z11', 'z13', 'z14'], hybridsWith: ['water_filtration', 'irrigation_link'], layer: 'foundation' },
  { id: 'water_filtration', name: 'Water Filtration Unit', icon: 'water_drop',
    ...
    compatibleZones: ['z3', 'z11'], hybridsWith: ['drainage_system'], layer: 'foundation' },
  { id: 'community_seating', name: 'Community Seating Area', icon: 'chair',
    ...
    compatibleZones: ['z1', 'z2', 'z3', 'z5', 'z6', 'z7', 'z9', 'z10', 'z11'], hybridsWith: ['cafe_space'], layer: 'activation' },
  { id: 'cafe_space', name: 'Community Cafe Kiosk', icon: 'local_cafe',
    ...
    compatibleZones: ['z1', 'z2', 'z3', 'z7', 'z13'], hybridsWith: ['community_seating'], layer: 'activation' },
  { id: 'native_plants', name: 'Native Plant Restoration', icon: 'park',
    ...
    compatibleZones: ['z3', 'z4', 'z5', 'z7', 'z8', 'z10', 'z11', 'z12', 'z13'], hybridsWith: ['ecological_buffer'], layer: 'sustainability' },
  { id: 'playground_equipment', name: 'Playground Equipment Overhaul', icon: 'sports_soccer',
    ...
    compatibleZones: ['z6', 'z7'], hybridsWith: ['safety_surfacing'], layer: 'foundation' },
  { id: 'safety_surfacing', name: 'Impact-Absorbing Surface', icon: 'layers',
    ...
    compatibleZones: ['z5', 'z6', 'z7', 'z10'], hybridsWith: ['playground_equipment'], layer: 'foundation' },
  { id: 'walking_path', name: 'Walking Path Restoration', icon: 'route',
    ...
    compatibleZones: ['z1', 'z5', 'z7', 'z10', 'z11', 'z13'], hybridsWith: ['path_lighting'], layer: 'foundation' },
  { id: 'path_lighting', name: 'Solar Path Lighting', icon: 'light_mode',
    ...
    compatibleZones: ['z1', 'z2', 'z5', 'z6', 'z7', 'z9', 'z10', 'z13'], hybridsWith: ['walking_path'], layer: 'foundation' },
  { id: 'signage_system', name: 'Wayfinding & Information Signage', icon: 'signpost',
    ...
    compatibleZones: ['z1', 'z2', 'z3', 'z4', 'z5', 'z6', 'z7', 'z8', 'z9', 'z10', 'z11', 'z12', 'z13', 'z14'], hybridsWith: [], layer: 'activation' },
  { id: 'waste_management', name: 'Waste Collection System', icon: 'delete',
    ...
    compatibleZones: ['z1', 'z2', 'z3', 'z5', 'z6', 'z7', 'z9', 'z10', 'z12', 'z13', 'z14'], hybridsWith: [], layer: 'sustainability' },
  { id: 'irrigation_link', name: 'Irrigation Network Extension', icon: 'water',
    ...
    compatibleZones: ['z4', 'z8', 'z11', 'z12', 'z14'], hybridsWith: ['drainage_system'], layer: 'sustainability' },
  { id: 'ecological_buffer', name: 'Ecological Buffer Zone', icon: 'forest',
    ...
    compatibleZones: ['z3', 'z4', 'z5', 'z8', 'z10', 'z11'], hybridsWith: ['native_plants'], layer: 'sustainability' },
  { id: 'vendor_market', name: 'Organized Vendor Market', icon: 'store',
    ...
    compatibleZones: ['z1', 'z2', 'z7', 'z13'], hybridsWith: ['cafe_space'], layer: 'activation' },
  { id: 'community_governance', name: 'Community Management Committee', icon: 'groups',
    ...
    compatibleZones: ['z1', 'z2', 'z3', 'z4', 'z6', 'z7', 'z8', 'z9', 'z12', 'z13', 'z14'], hybridsWith: [], layer: 'activation' },
  ...
  { id: 'solar_pump', name: 'Solar-Powered Water Pump', icon: 'solar_power',
    ...
    compatibleZones: ['z3', 'z4', 'z8', 'z11', 'z13', 'z14'], hybridsWith: ['fountain_repair', 'irrigation_link'], layer: 'foundation' },
  { id: 'amphitheatre', name: 'Open-Air Amphitheatre', icon: 'theater_comedy',
    ...
    compatibleZones: ['z2', 'z3', 'z7', 'z13'], hybridsWith: ['community_seating'], layer: 'activation' },
  { id: 'heritage_trail', name: 'Heritage Interpretation Trail', icon: 'museum',
    ...
    compatibleZones: ['z1', 'z2', 'z3', 'z5', 'z10'], hybridsWith: ['signage_system', 'walking_path'], layer: 'activation' },
  { id: 'rainwater_harvest', name: 'Rainwater Harvesting System', icon: 'water_drop',
    ...
    compatibleZones: ['z3', 'z4', 'z7', 'z8', 'z11', 'z12', 'z14'], hybridsWith: ['irrigation_link', 'drainage_system'], layer: 'foundation' },
  ...
  { id: 'night_market', name: 'Weekend Night Market', icon: 'nightlife',
    ...
    compatibleZones: ['z1', 'z2', 'z7', 'z13'], hybridsWith: ['vendor_market', 'cafe_space'], layer: 'activation' },
  { id: 'butterfly_garden', name: 'Butterfly & Pollinator Garden', icon: 'psychiatry',
    ...
    compatibleZones: ['z3', 'z4', 'z5', 'z7', 'z8', 'z11'], hybridsWith: ['native_plants', 'ecological_buffer'], layer: 'sustainability' },
  { id: 'smart_monitoring', name: 'IoT Environmental Monitoring', icon: 'sensors',
    ...
    compatibleZones: ['z3', 'z4', 'z5', 'z6', 'z8', 'z11', 'z12', 'z14'], hybridsWith: ['water_filtration'], layer: 'foundation' },
  { id: 'skill_workshop', name: 'Community Skill Workshop Space', icon: 'construction',
    ...
    compatibleZones: ['z7', 'z8', 'z9', 'z12', 'z13'], hybridsWith: ['community_governance'], layer: 'activation' },
  { id: 'public_art', name: 'Community Mural & Art Installations', icon: 'palette',
    ...
    compatibleZones: ['z1', 'z2', 'z3', 'z5', 'z6', 'z7', 'z10', 'z13'], hybridsWith: ['heritage_trail'], layer: 'activation' },
  ...
  { id: 'outdoor_classroom', name: 'Outdoor Classroom', icon: 'school',
    ...
    compatibleZones: ['z3', 'z4', 'z6', 'z7', 'z8'], hybridsWith: ['skill_workshop'], layer: 'activation' },
  { id: 'senior_wellness', name: 'Senior Wellness Corner', icon: 'elderly',
    ...
    compatibleZones: ['z2', 'z3', 'z5', 'z7'], hybridsWith: ['community_seating'], layer: 'activation' },
  { id: 'youth_sports', name: 'Youth Sports Zone', icon: 'sports_soccer',
    ...
    compatibleZones: ['z2', 'z6', 'z7', 'z13'], hybridsWith: ['playground_equipment'], layer: 'activation' },
  { id: 'womens_corner', name: 'Womens Safety Corner', icon: 'female',
    ...
    compatibleZones: ['z1', 'z2', 'z3', 'z5', 'z7'], hybridsWith: ['path_lighting'], layer: 'activation' },
  { id: 'cultural_wall', name: 'Community Story Wall', icon: 'auto_stories',
    ...
    compatibleZones: ['z1', 'z2', 'z3', 'z7', 'z9', 'z13'], hybridsWith: ['heritage_trail'], layer: 'activation' },
  { id: 'pet_friendly', name: 'Pet-Friendly Zone', icon: 'pets',
    ...
    compatibleZones: ['z3', 'z5', 'z7', 'z10'], hybridsWith: [], layer: 'activation' },
  { id: 'reading_nook', name: 'Open-Air Reading Nook', icon: 'menu_book',
    ...
    compatibleZones: ['z2', 'z3', 'z5', 'z7', 'z9'], hybridsWith: [], layer: 'activation' },
  ...
  { id: 'fish_restocking', name: 'Native Fish Restocking', icon: 'phishing',
    ...
    compatibleZones: ['z3', 'z11'], hybridsWith: ['water_filtration'], layer: 'sustainability' },
  { id: 'composting_hub', name: 'Community Composting Hub', icon: 'compost',
    ...
    compatibleZones: ['z4', 'z7', 'z8', 'z12', 'z13'], hybridsWith: ['waste_management'], layer: 'sustainability' },
  { id: 'eco_tourism', name: 'Eco-Tourism Circuit', icon: 'tour',
    ...
    compatibleZones: ['z3', 'z4', 'z5', 'z7', 'z8', 'z12', 'z13'], hybridsWith: ['heritage_trail'], layer: 'sustainability' },
  { id: 'solar_charging', name: 'Solar Charging Station', icon: 'solar_power',
    ...
    compatibleZones: ['z1', 'z2', 'z5', 'z7', 'z9', 'z13', 'z14'], hybridsWith: ['solar_pump'], layer: 'sustainability' },
  { id: 'medicinal_garden', name: 'Medicinal Plant Trail', icon: 'spa',
    ...
    compatibleZones: ['z3', 'z4', 'z8'], hybridsWith: ['native_plants'], layer: 'sustainability' },
  { id: 'food_forest', name: 'Micro Food Forest', icon: 'forest',
    ...
    compatibleZones: ['z3', 'z4', 'z7', 'z8', 'z12', 'z13'], hybridsWith: ['ecological_buffer'], layer: 'sustainability' },
  { id: 'vendor_cooperative', name: 'Vendor Cooperative Model', icon: 'handshake',
    ...
    compatibleZones: ['z1', 'z2', 'z7', 'z13'], hybridsWith: ['vendor_market'], layer: 'sustainability' },
];
...
export function logFeatureAvailability(): void {
  const zones = ['z1', 'z2', 'z3', 'z4', 'z5', 'z6', 'z7', 'z8', 'z9', 'z10', 'z11', 'z12', 'z13', 'z14'];
  ...
  for (const z of zones) {
    for (const s of sets) {
      ...
      if (count < 3) console.warn(`LOW_FEATURES: ${z} ${FEATURE_SET_LABELS[s]} only ${count} — minimum 3 needed`);
      else console.log(`${label}: ${count}`);
    }
  }
}

/** Verify all zones have adequate feature coverage */
export function verifyZoneFeatureCounts(): void {
  const zones = ['z1', 'z2', 'z3', 'z4', 'z5', 'z6', 'z7', 'z8', 'z9', 'z10', 'z11', 'z12', 'z13', 'z14'];
  const sets: FeatureSet[] = ['infrastructure', 'community', 'ecology'];
  let warnings = 0;
  for (const zone of zones) {
    for (const set of sets) {
      const count = getVisionTilesForZoneAndSet(zone, set).length;
      console.log(`FEATURE_COUNT: ${zone} ${set} ${count}`);
      if (count < 3) { console.warn(`LOW_FEATURES: ${zone} ${set} only ${count} — minimum 3 needed`); warnings++; }
    }
  }
  console.log(`VERIFY_COMPLETE: ${zones.length * sets.length} combinations checked, ${warnings} warnings`);
}
